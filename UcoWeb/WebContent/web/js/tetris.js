$(document).ready(function(){
	...
	function initStage(){
		...
		new Game(background, foreground);
...
//		var W = Math.floor(parseFloat($("#container").css("width"))/100)*100;
	...
	function Piece(foreground){
		...
		//Piece _|_
		this.xPiece[1]= new Array(0, 1,-1, 0);
		this.yPiece[1]= new Array(0, 0, 0, 1);
		
		//Piece |__
		this.xPiece[2]= new Array(0, 1,-1,-1);
		this.yPiece[2]= new Array(0, 0, 0, 1);
		
		//Piece __|
		this.xPiece[3]= new Array(0, 1,-1, 1);
		this.yPiece[3]= new Array(0, 0, 0, 1);
		
		//Piece _|-
		this.xPiece[4]= new Array(0,-1, 1, 0);
		this.yPiece[4]= new Array(0, 0, 1, 1);
		
		//Piece -|_
		this.xPiece[5]= new Array(0, 1,-1, 0);
		this.yPiece[5]= new Array(0, 0, 1, 1);
		
		//Piece --
		this.xPiece[6]= new Array(0, 1,-1,-2);
	...
	function Game(background, foreground) {
